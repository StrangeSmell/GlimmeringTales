...
public class MagmaSpells extends NatureSpellEntry {

	public static final ResourceLocation ID = GlimmeringTales.loc("magma");
	...
	public void regBlock(DataMapProvider.Builder<BlockSpell, Block> builder) {
		builder.add(Blocks.MAGMA_BLOCK.builtInRegistryHolder(), new BlockSpell(NATURE, false, 0), false);
		builder.add(GTTagGen.FAKE_MAGMA, new BlockSpell(NATURE, false, 0), false);
	}
